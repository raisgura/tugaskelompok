 ...
 * @author darwisy
 */
public class ReportJadwalShift extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN JADWAL SHIFT");
        ...
        btnPrintKd.setText("CETAK BY KODE SHIFT");
        ...
        jLabel3.setText("Pilih rentang tanggal untuk mencetak daftar Jadwal Shift");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnPrintKd, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(558, 558, 558)
    ...
    private void btnPrintTglActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintTglActionPerformed
        try {
            ...
            String reportPath = "C:\\Users\\acied\\OneDrive\\Documents\\NetBeansProjects\\rskita\\RumahSakitKita\\KJadwalShift.jrxml";
    ...
    private void btnPrintKdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintKdActionPerformed
        ...
        // 1. Prepare parameters
        Map<String, Object> parameter = new HashMap<String, Object>();
        String selectedNO = tblPetugas.getValueAt(tblPetugas.getSelectedRow(), 0).toString().trim();
        
        parameter.put("kd_shift", selectedNO);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportJadwalShift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportJadwalShift().setVisible(true);
            }
        });
    }
